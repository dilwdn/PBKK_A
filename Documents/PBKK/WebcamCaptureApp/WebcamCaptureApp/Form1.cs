...
namespace WebcamCaptureApp
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            {
                comboBoxWbcamList.Items.Add(deviceList.Name);
            }
            comboBoxWbcamList.SelectedIndex = 0;
        ...
        private void buttonStart_Click(object sender, EventArgs e)
        {
            ...
            videoSource = new VideoCaptureDevice(captureDevice[comboBoxWbcamList.SelectedIndex].MonikerString);
